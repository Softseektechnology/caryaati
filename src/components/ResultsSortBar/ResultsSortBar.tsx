...
const ResultsSortBar = ({ resultCount = 375, defaultSort = "Our recommendation" }) => {
  ...
  return (
    <div className={`${styles.resultsSortBar} flex resultSortBar max-lg:mt-5 z-[-1] justify-between items-center py-[10px] px-[20px] max-sm:px-[7px] flex-nowrap w-[60%] max-xl:w-[71vw] max-sm:w-[92vw] max-sm:ml-0 ml-[95px] max-xl:ml-[60px] max-md:ml-[0px] max-md:w-[80vw] bg-[#f0f3f5] gap-10`}>
