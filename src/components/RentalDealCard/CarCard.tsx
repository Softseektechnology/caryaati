...
const extraContent: { [key: string]: { image: string; description: string } } = {
  insurance: {
    ...
    description: 'Full comprehensive insurance including drivers and passengers...',
  },
  gps: {
    image: 'https://www.caryaati.com/images/car-card/gps.png',
    description: 'The satellite navigation system provides turn-by-turn directions...',
  },
  infantSeat: {
    image: 'https://www.caryaati.com/images/car-card/infant2.png',
    description: 'Recommended for children weighing under 20 lbs / 9kg...',
  },
  childBoosterSeat: {
    image: 'https://www.caryaati.com/images/car-card/booster2.png',
    description: 'Recommended for children weighing 18kg-30 (Approx 4 - 7 years)...',
  },
  childSafetySeat: {
    image: 'https://www.caryaati.com/images/car-card/chalid_safty2.png',
    description: 'Recommended for children weighing 20-40 lbs / 9-18kg...',
  },
  additionalDriver: {
    image: 'https://www.caryaati.com/images/car-card/add_driver.jpg',
    description: 'Take turns in the driver\'s seat and enjoy the journey...',
  },
  deliveryCharges: {
    image: 'https://www.caryaati.com/images/car-card/delivery.jpeg',
    description: 'Delivery charges may vary as per location...',
  },
  pickupCharges: {
    image: 'https://www.caryaati.com/images/car-card/pickup.jpeg',
    description: 'Pickup charges may vary as per location...',
  },
  totalCharges: {
    image: 'https://www.caryaati.com/images/car-card/total_cahrges.jpg',
    description: 'This is the estimated total of optional/additional charges only...',
  },
};
...
const CarCard: React.FC<CarProps> = ({
  ...
  const settings = {
    ...
    responsive: [
      ...
      {
        breakpoint: 768,
        settings: { slidesToShow: 4, slidesToScroll: 1, infinite: true, dots: true, arrows: true },
      },
      {
        breakpoint: 641,
        settings: { slidesToShow: 4, slidesToScroll: 1, infinite: true, arrows: false, dots: true },
      },
      {
        breakpoint: 480,
        settings: { slidesToShow: 3, slidesToScroll: 1, infinite: true, dots: true, arrows: false },
      },
    ],
  };
  ...
  const getIconComponent = (iconName: string) => {
    switch (iconName) {
      case 'Suitcase': return <span className="material-icons">luggage</span>;
      case 'People': return <span className="material-icons">groups</span>;
      case 'Gear': return <span className="material-icons">settings</span>;
      case 'Snow': return <span className="material-icons">ac_unit</span>;
      default: return null;
    }
  };
  ...
  const renderFeatures = (): Feature[] => {
    ...
    if (ac) features.push({ icon: 'Snow', label: 'A/C' });
    return features;
  };
  ...
  return (
    <>
        ...
        >
          ...
          <div className="bg-white rounded-[20px] shadow-xl p-6 overflow-hidden">
            <div className="flex mb-8">
              <button
                className={`flex-1 py-4 bg-gray-100 text-gray-600 font-semibold transition-all duration-300 ${
                  !isSignup ? 'bg-gradient-to-r from-blue-600 to-cyan-400 text-white rounded-t-[10px]' : ''
                }`}
      ...
      <div className={styles.carCard} style={{ marginBottom: '20px' }}>
        ...
        <div
          className={`fixed inset-0 z-[2000] flex items-center justify-center transition-opacity duration-300 ${showInfo ? 'opacity-100' : 'opacity-0 pointer-events-none'
            }`}
        >
          <div className="fixed inset-0 bg-black bg-opacity-50" onClick={closePopup}></div>
          <div
            className={`relative bg-white rounded-xl shadow-2xl p-6 max-w-md w-full transform transition-all duration-300 ${showInfo ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
              }`}
          >
            <button
        ...
        <div className={`${styles.left} max-md:w-full`}>
          <img src={selectedCar} alt="Car" width={250} height={200} className={styles.image} />
          ...
          <div className={`${styles.middleFlipper} ${carDetail ? styles.flipped : ''}`}>
            <div className={`${styles.middleContent} h-full ${styles.front}`}>
              <div className={`${styles.location}`}>
                <span className="px-4 text-white py-[5px] rounded-lg font-medium bg-[#ff0000] bg-opacity-50">Sedan</span>
                <span className="px-4 text-white py-[5px] ml-2 rounded-lg font-medium bg-[#ffc107c4] bg-opacity-50">Featured</span>
              </div>
              ...
              <div className={`${styles.features}`} style={{ display: 'flex', flexDirection: 'row', gap: '10px' }}>
                {renderFeatures().map((feature, index) => (
                  <span key={index} className={`${styles.featureItem} items-center content-center`}>
                    {getIconComponent(feature.icon)} {feature.label}
                  </span>
                ))}
              </div>
              ...
              <ul className={`${styles.features} ${styles.backFeatures} relative left-[-1px]`}>
                <li className="flex items-center mb-2 content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#1f1f1f">
                    <path d="M480-564.5q-27.5 0-45.75-18.5T416-629q0-27.5 18.49-45.75T480.53-693q27.14 0 45.55 18.37 18.42 18.37 18.42 45.75T526-583q-18.5 18.5-46 18.5Zm-244.5 130q-23.72 0-40.61-16.89T178-492v-273.5q0-23.72 16.89-40.61T235.5-823h490q23.72 0 40.61 16.89T783-765.5V-492q0 23.72-16.89 40.61T725.5-434.5h-490ZM262-460h437q0-24.5 17.18-41.75Q733.37-519 757.5-519v-219.5q-24.5 0-41.5-17.38-17-17.37-17-41.62H262q0 24.5-17.18 41.75Q290.13-647 266-647v219.5q24.5 0 41.5 17.37 17 17.38 17 41.63Zm-58.5 0v-337.5V-460ZM481-137l121.5-121.5-17.5-17-91 91v-171h-26.5v171l-91.5-91-17 17L481-137Z" />
                  </svg>
                  <span className="ml-1 w-[65px]">Deposit:</span> 1000 AED
                </li>
                <li className="flex items-center mb-2 content-center">
                  ...
                  <span className="ml-1 w-[65px]">Mileage:</span> 4500 KM
                </li>
                <li className="flex items-center mb-2 content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#000000">
                    <path d="M480-100.77q-129.77-35.39-214.88-152.77Q180-370.92 180-516v-230.15l300-112.31 300 112.31V-516q0 145.08-85.12 262.46Q609.77-136.16 480-100.77Zm0-63.23q104-33 172-132t68-220v-189l-240-89.62L240-705v189q0 121 68 220t172 132Zm0-315.62Z" />
                  </svg>
                  <span className="ml-1 w-[65px]">Insurance:</span> Comprehensive
                </li>
                <li className="flex items-center mb-2 content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#1f1f1f">
                    <path d="M533.25-473q-27.25 0-45.75-18.5t-18.5-46q0-27.5 18.49-45.75t46.04-18.25q27.14 0 45.55 18.37 18.42 18.37 18.42 45.75t-18.17 45.88Q561.17-473 533.25-473ZM298-343q-23.72 0-40.61-16.89T240.5-400.5V-674q0-23.72 16.89-40.61T298-731.5h471q23.72 0 40.61 16.89T826.5-674v273.5q0 23.72-16.89 40.61T769-343H298Zm26.5-25.5h418q0-24.5 17.18-41.75Q776.87-427.5 801-427.5V-647q-24.5 0-41.5-17.38-17-17.37-17-41.62h-418q0 24.5-17.18 41.75Q290.13-647 266-647v219.5q24.5 0 41.5 17.37 17 17.38 17 41.63Zm385 132H191q-23.72 0-40.61-16.89T133.5-294v-320.5H159V-294q0 12 10 22t22 10h518.5v25.5ZM298-368.5h-32V-706h32q-13 0-22.5 9.5T266-674v273.5q0 13 9.5 22.5t22.5 9.5Z" />
                  </svg>
                  <span className="ml-1 w-[65px]">Payment:</span> Credit Card
                </li>
                <li className="flex items-center mb-2 content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#000000">
                  ...
                  <span className="ml-1 w-[65px]">Engine:</span> 1.5 L
                </li>
                <li className="flex items-center mb-2 content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#000000">
                  ...
                  <span className="ml-1 w-[65px]">Colors:</span>
                  <input type="color" className="rounded-full w-4 h-4 translate-x-[4px]" disabled />
                </li>
                <li className="flex items-center mb-2 content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#000000">
              ...
              >
                ...
                <span className="text-[#0080F6]">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#0080F6">
            ...
            <div className={`${styles.middleContent} bg-transparent ${styles.back}`}>
              ...
              <div className="flex flex-col pb-2 md:w-[45%] relative">
                <div className="block mb-[2px] text-[12px] font-medium">
                  <span>30 Days :</span>
                  <span className="float-right">
                    <span className="theme-text-color pr-2">3000.90</span>AED
                  </span>
                </div>
                <div className="block mb-[2px] text-[12px] font-medium">
                  <span>15 Days :</span>
              ...
              <ul className={`${styles.features} ${styles.backFeatures} ${styles.switchFeatures} relative left-[-4px]`}>
                {[
                  { key: 'insurance', label: 'Full Insurance', checked: insurance, setter: setInsurance },
                  { key: 'gps', label: 'GPS Navigation', checked: gps, setter: setGps },
                  { key: 'infantSeat', label: 'Infant Seat', checked: infantSeat, setter: setInfantSeat },
                  { key: 'childBoosterSeat', label: 'Child Booster', checked: childBoosterSeat, setter: setChildBoosterSeat },
                  { key: 'childSafetySeat', label: 'Child Safety', checked: childSafetySeat, setter: setChildSafetySeat },
                  { key: 'additionalDriver', label: 'Additional Driver', checked: additionalDriver, setter: setAdditionalDriver },
                  { key: 'deliveryCharges', label: 'Delivery', checked: deliveryCharges, setter: setDeliveryCharges },
                  { key: 'pickupCharges', label: 'Pickup', checked: pickupCharges, setter: setPickupCharges },
                ].map((item) => (
                  <li key={item.key} className="flex items-center text-[12px] mb-2 content-center">
                    <label className={styles.switch}>
                      <input
                        type="checkbox"
                        checked={item.checked}
                        onChange={() => item.setter((prev: boolean) => !prev)}
                      />
                      <span className={styles.sliderBox}></span>
                    </label>
                    <span className="w-[100px]">{item.label}:</span>
                    {extraCosts[item.key]} AED
                    <span className="ml-[1px] cursor-pointer" onClick={() => handleInfoClick(item.key)}>
                      <svg
              ...
              <div className="flex absolute right-0 text-[12px] mb-2 translate-y-[-14px] items-center content-center font-bold">
                Total: {totalExtraCharges} AED
                <span className="ml-[4px] cursor-pointer" onClick={() => handleInfoClick('totalCharges')}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="24px"
                    viewBox="0 -960 960 960"
              ...
              <span
                ...
                onClick={() => setCarDetail((prev) => !prev)}
                aria-label="Back to main details"
              >
                <span className="text-[#0080F6]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className={`${styles.right} items-center content-center`}>
          <div className={`${styles.provider} mt-4`}>Rent for 30 Days <br /></div>
          ...
          <br />
          <Link href="/Booknow">
            <button className={`${styles.dealBtn} bg-[#0080F6] relative hover:bg-[#42C3F7]`} aria-label="Book now">
              Book Now
            </button>
          </Link>
          <div className={`flex items-center text-[11px] ${styles.subject} max-lg:float-right relative lg:left-[7px] max-xl:mt-3 max-lg:left-32 ml-1 mr-2`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="14px"
              viewBox="0 -960 960 960"
              ...
              fill="#ffc107"
            >
              <path d="m313-230.5 44.5-190.09L210-548l194-17 76-179 76.5 179L750-548 602.48-420.59l44.96 190.09-167.22-101.11L313-230.5Z" />
            </svg>
