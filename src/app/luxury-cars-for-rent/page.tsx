...
import RentalLayout from '../../components/LuxuryRentalDealCard/RentalDealCard';
...
export default function RentACarListings() {
  ...
  return (
    <div className={styles.container}>
      <Navbar onMenuToggle={toggleSidebar} luxury={true} isHome={false} onUserToggle={toggleUserDropdown} />
