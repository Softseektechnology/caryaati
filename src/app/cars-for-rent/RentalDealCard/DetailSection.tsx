...
import styles from '../../../components/homepage-subcategory/carcategories.module.css';
...
const DetailSection = ({ logo }: DetailProps) => {
    return (
        <>
            <div className={`${styles.carTypeContainer} ${styles.detailSection} max-lg:justify-start lg:py-2 relative max-lg:top-[-60px] max-lg:justify-items-start w-[270px]`} style={{marginTop: '0px'}}>
