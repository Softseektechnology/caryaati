...
import InquiryButtton from './InquiryButtton';
...
function SamplePrevArrow(props) {
  ...
  return (
    <div className={styles.carCard} style={{ marginBottom: '20px' }}>
        ...
        <div className={`${styles.middleFlipper} ${carDetail ? styles.flipped : ''}`}>
          ...
          <div className={`${styles.middleContent} h-full ${styles.front}`}>
            ...
            <div className={`${styles.titleRow} mt-2 translate-y-[0px]`} style={{marginTop: '0px'}}>
              <h4 className='mb-0' style={{marginTop: '5px'}}>{name}</h4>

            </div>
            <div className='text-red-600'>{availability} Cars Available for Booking.</div>
            <p className={styles.subtext}>Specification</p>
          ...
          <div className={`${styles.middleContent} bg-transparent ${styles.back}`}>
            ...
            <ul className={`${styles.features} ${styles.backFeatures} relative left-[-4px]`}>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                ...
                <span className='w-[100px]'>Full Insurance:</span>350 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('insurance')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>GPS Navigation:</span>300 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('gps')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>Infant Seat:</span>300 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('infantSeat')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>Child Booster:</span>300 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('childBoosterSeat')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>Child Safety:</span>300 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('childSafetySeat')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>Additional Driver:</span>0 AED<span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('additionalDriver')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>Delivery:</span>0 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('deliveryCharges')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
              <li className='flex items-center text-[12px] mb-2 content-center'>
                <label className={styles.switch}>
                ...
                <span className='w-[100px]'>Pickup:</span>0 AED <span className='ml-[1px] cursor-pointer' onClick={() => handleInfoClick('pickupCharges')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span>
              </li>
            </ul>
            <div className='flex absolute right-0 text-[12px] mb-2 translate-y-[-14px] items-center content-center font-bold'>Total: {totalExtraCharges} AED <span className='ml-[4px] cursor-pointer' onClick={() => handleInfoClick('totalCharges')}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="12px" fill="#1f1f1f"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Zm0 520q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg></span></div>
            <span
              className={`${styles.detailBtn} flex items-center content-center absolute bottom-[-20.4%] left-[-3.5%]`}
              onClick={() => setCarDetail((prev) => !prev)}
            >
              <span className='text-[#0080F6]'>
      ...
      {/* Right */}
      <div className={`${styles.right} items-center content-center`}>
        ...
        <div className={`${styles.provider} mt-4`}>
          Rent for 30 Days <br />
        </div>
        <div className="text-gray-700 text-[16px]">AED 1780</div>
        <div className={`h-[1px] w-[75px] bg-gray-500 relative top-[-4.2%] max-lg:top-[-12px] ${styles.crossLine} z-1 max-lg:float-left float-right`}></div>
